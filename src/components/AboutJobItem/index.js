...
class AboutJobItem extends Components {
  state = {
    jobDataDetails: [],
    similarJobsData: [],
  ...
  getJobData = async props => {
    ...
    const jobDetailsApiUrl = `http://apis.ccbp.in/jobs/${id}`
            ...
            <div className="first-part-container">
              <div className="img-title-container">
                <img
                  ...
                  src={companyLogoUrl}
                  alt="jod detials company logo"
                />
                <div className="title-rating-container">
                  <h1 className="tilte-heading">{title}</h1>
              ...
              <div className="location-package-container">
                <div className="location-job-type-container">
                  <div className="location-icon-location-conatiner">
  ...
  renderJobLoadingView = () => (
    <div className="job-details-loader" data-testid="loader">
      <Loader typ="ThreeDots" color="#0b69ff" height="50" width="50" />
    </div>
  )
